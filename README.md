...
# HISTÓRIAS DO USUÁRIO (FUNCIONALIDADES) 
> # H1
...
> 
> # H2
> > Eu, como usuário (doador), gostaria de poder fazer uma doação única para a organização, porque já doei para outra instituição esse mês, mas mesmo assim quero ajudar a ONG de animais da minha cidade, pois ví que estão precisando de dinheiro para a cirurgia de um gatinho que foi acolhido com a pata quebrada.
>
>
> # H3
> > Eu, como um doador em potencial, desejo acessar relatórios de prestação de contas da organização, a fim de tomar decisões informadas sobre onde direcionar minhas doações. Isso me ajudará a entender como a organização utiliza os recursos e qual impacto ela gera, permitindo-me tomar decisões mais conscientes e alinhadas com meus valores.
...
>
> # H7
> >  Eu, como um doador regular de uma ONG, desejo receber atualizações regulares sobre o impacto das minhas doações. Me mantendo informado sobre como minha contribuição está sendo usada para causar mudanças positivas, 
reforço meu engajamento contínuo com a organização.
>
>
> # H8
...
>
> # H10
> >  Eu, como usuário e doador, gostaria de ter uma aba de confirmação de pagamento após realizar uma doação, para ter certeza de que minha contribuição foi processada com sucesso e recebida pela organização, proporcionando transparência e segurança no processo de doação.
